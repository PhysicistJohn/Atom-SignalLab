...
The BLE engineering schedule uses fixed primary-center order and packet timing
plus a seeded per-event pseudorandom 0–10 ms `advDelay`; it is not universal
Bluetooth event, channel-map, order, or PDU behavior. The n3 `carrierRasterHz`
