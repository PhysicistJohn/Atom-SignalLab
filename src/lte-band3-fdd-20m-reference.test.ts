...
/**
 * Architecture-tolerant companions to LTE_BAND3_FDD_20M_REFERENCE_IDENTITIES.
 *
 ...
 */
const LTE_BAND3_FDD_20M_QUANTIZED_IDENTITIES = Object.freeze({
  gridQuantizedSha256: '827bfcbb4f1ad7c241bcc8df894dd4956f8646685b67cc0d4dc5466ec6d735b7',
  timeQuantizedSha256: '338f37e271c0a85a7196f28f4e79e6a887014edf2ba29a36e06ba76a7d99323f',
});
...
describe('fixed LTE Band-3 20 MHz FDD digital reference', () => {
  ...
  it('is deterministic and exposes stable full-grid/full-frame identities', () => {
    ...
    expect(quantizedIdentities).toEqual(LTE_BAND3_FDD_20M_QUANTIZED_IDENTITIES);
